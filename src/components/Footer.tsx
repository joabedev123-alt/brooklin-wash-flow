        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mt-4">
              <a
                href="https://www.facebook.com/lavatriunfo"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/lavatriunfo/?igshid=YmMyMTA2M2Y%3D"
                target="_blank"
                rel="noopener noreferrer"
                className="text-primary-foreground hover:text-primary-foreground/80 transition-colors"
          ...
          {/* Links */}
          <div>
            <h4 className="text-lg font-semibold text-primary-foreground mb-4">Links Úteis</h4>
          ...
          {/* Contact */}
          <div>
            <h4 className="text-lg font-semibold text-primary-foreground mb-4">Contato</h4>
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <Mail className="w-5 h-5 text-primary-foreground flex-shrink-0 mt-1" />
                <a
              ...
              <li className="flex items-start gap-3">
                <Phone className="w-5 h-5 text-primary-foreground flex-shrink-0 mt-1" />
                <a
              ...
              <li className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-primary-foreground flex-shrink-0 mt-1" />
